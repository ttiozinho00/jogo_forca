...
#include "console_v1.5.5.h" /* cabeçalho de todas as novas funções definidas neste arquivo */
...
EVENTO Evento(void)
{
	...
	switch(irInBuf.EventType)
	{
		   case KEY_EVENT: /* keyboard input  */
				...
				Dados_evento.teclado.key_code = irInBuf.Event.KeyEvent.wVirtualKeyCode; /* armazenar o código da tecla
				pressionada */
