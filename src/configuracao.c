...
void ajustarDificuldade(void)
{
    ...
    textcolor(WHITE);
    gotoxy(5, 3);
    printf("=== CONFIGURACAO DE DIFICULDADE ===");

    gotoxy(5, 5);
    printf("Dificuldade Atual: ");

    textcolor(YELLOW);
    printf("%s", obterNomeDificuldade());

    textcolor(WHITE);
    gotoxy(5, 7);
    printf("[1] Facil   (8 Vidas)");

    gotoxy(5, 8);
    printf("[2] Medio   (6 Vidas)");

    gotoxy(5, 9);
    printf("[3] Dificil (4 Vidas)");

    gotoxy(5, 11);
    printf("Escolha uma opcao clicando na tecla... ");
    ...
    {
        case '1':
            dificuldadeAtual = DIFICULDADE_FACIL;
            break;

        case '2':
            dificuldadeAtual = DIFICULDADE_MEDIO;
            break;

        case '3':
            dificuldadeAtual = DIFICULDADE_DIFICIL;
            break;
    ...
    printf("Dificuldade alterada para '%s' com sucesso!",
           obterNomeDificuldade());
